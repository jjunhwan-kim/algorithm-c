...
void merge(MyData arr[MAX_SIZE], int (*compare)(MyData*, MyData*), int startIndex, int endIndex);

void mergeSort(MyData* arr, int (*compare)(MyData*, MyData*), int startIndex, int endIndex)
{
